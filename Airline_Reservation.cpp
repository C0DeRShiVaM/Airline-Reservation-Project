...
class registration{
    ...
    void flights(){
        ...
        switch(choice){
            case 1:{
                cout << "______________________Welcome to Dubai Emirates______________\n" << endl;
            ...
            case 2: {
                cout << "______________________Welcome to Canadian Airlines______________\n" << endl;
                cout << "Your comfort is our priority. Enjoy the journey!" << endl;
                cout << "Following are the flights \n" << endl;
            ...
            case 3: {
                ...
                cout << "______________________Welcome to UK Airways______________\n" << endl;
                cout << "Your comfort is our priority. Enjoy the journey!" << endl;
                cout << "Following are the flights \n" << endl;
            ...
            case 4: {
                cout << "______________________Welcome to US Airways______________\n" << endl;
                cout << "Your comfort is our priority. Enjoy the journey!" << endl;
                cout << "Following are the flights \n" << endl;
            ...
            case 5: {
                cout << "______________________Welcome to Australian Airlines______________\n" << endl;
                cout << "Your comfort is our priority. Enjoy the journey!" << endl;
                cout << "Following are the flights \n" << endl;
                ...
                cout << "1. AUS - 688" << endl;
                cout << "\t19-01-2022 9:00AM 22hrs Rs. 34000" << endl;
                cout << "1. AUS - 598" << endl;
                cout << "\t21-01-2022 12:00AM 21hrs Rs. 42000" << endl;
                ...
                if (choice1 == 1){
                    ...
                    charges = 34000;
                    cout << "\nYou have successfully booked the flight AUS - 688" << endl;
                    cout << "You can go back to menu and take the ticket" << endl;
                }
                else if (choice1 == 3){
                    charges = 42000;
                    cout << "\nYou have successfully booked the flight AUS - 598" << endl;
                    cout << "You can go back to menu and take the ticket" << endl;
                }
                else{
                    cout << "Invalid input , shifting to the previous menu" << endl;
            ...
            case 6: {
                cout << "______________________Welcome to European Airlines______________\n" << endl;
                cout << "Your comfort is our priority. Enjoy the journey!" << endl;
                cout << "Following are the flights \n" << endl;
                
                cout << "1. EU - 490" << endl;
                cout << "\t08-01-2022 9:00AM 17hrs Rs. 36000" << endl;
                cout << "1. EU - 650" << endl;
                cout << "\t09-01-2022 5:00AM 12hrs Rs. 37000" << endl;
                cout << "1. EU - 500" << endl;
                cout << "\t11-01-2022 8:00AM 13hrs Rs. 31000" << endl;
                ...
                if (choice1 == 1){
                    ...
                    charges = 37000;
                    cout << "\nYou have successfully booked the flight EU - 650" << endl;
                    cout << "You can go back to menu and take the ticket" << endl;
                }
                else if (choice1 == 3){
                    charges = 31000;
                    cout << "\nYou have successfully booked the flight EU - 500" << endl;
                    cout << "You can go back to menu and take the ticket" << endl;
                }
                else{
                    cout << "Invalid input , shifting to the previous menu" << endl;
...
class ticket : public registration, Details {
    ...
    void Bill(){
        ...
        ofstream outf("records.txt");{
            outf << "____________XYZ Airlines____________" << endl;
...
void mainMenu(){
    ...
    int back;
    cout << "\t           XYZ Airlines \n" << endl;
    cout << "\t__________Main Menu_________________" << endl;
